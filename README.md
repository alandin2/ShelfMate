...
## App Overview
- **Home**: Find books other readers have liked, organized by subtitle. Click on books you want to get more details on. You will find a book summary and option to save to favorites. If you click more details, you will get the book's genre, publishing date, language, and rating. You'll also get the option to purchase the book from Amazon to share the link to the book.
